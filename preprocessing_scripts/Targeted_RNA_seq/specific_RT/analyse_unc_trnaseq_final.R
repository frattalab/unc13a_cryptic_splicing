...
# the most similar UMI. It also requires that each UMI is at least 1/100 times as abundant
...
just_C_or_G_tmp <- all_df %>%
    ...
    filter(nt == "G"|nt=="C")  %>%
    filter(!(sample_name == "P17_07"|sample_name =="P35_07"|sample_name=="P64_11"|sample_name == "P47_11"))
...
write_csv(just_C_or_G, "C:/Users/ogw/Google Drive/UCL PhD/Year 2/unc13a/from_home_targeted_seq_analysis/for_plot.csv")